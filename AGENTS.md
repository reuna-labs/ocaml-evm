...
Pure-OCaml Ethereum/EVM primitives — wire types, the Contract ABI, RLP — that run unchanged in a Unix program or a MirageOS/Solo5 unikernel.

## Where this repo sits

`~/reuna/web3/ocaml-evm` — the `web3/` group (OCaml/Mirage web3 protocol libraries).
